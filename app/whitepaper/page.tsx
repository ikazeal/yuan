const sections = [
  ...
  { id:"fortune", number:"肆", title:"缘签机制", text:["正式版本会在用户授权后读取 ERC-20 余额，持有数量大于零即可进入抽签流程。抽签结果由公开规则生成，并记录必要的验证信息；产品只请求完成验证所需的最少钱包权限。", "测试阶段暂时采用‘连接钱包即可体验’模式。配置正式合约后，前端会自动切换为持币门槛。任何签文仅用于文化娱乐与自我观照，不构成投资、医疗、法律或人生决策建议。"] },
...
export default function Whitepaper(){
  return <main className="paper-page">
    <header className="paper-nav"><a className="brand" href="/"><span className="lotus">缘</span></a><nav><a href="/">返回首页</a><a href="#vision">愿景</a><a href="#token">代币</a><a href="#roadmap">路线图</a></nav><a className="paper-x" href={process.env.NEXT_PUBLIC_X_URL || "https://x.com/"} target="_blank" rel="noreferrer">关注 𝕏</a></header>
